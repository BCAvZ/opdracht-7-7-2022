...
// Sc
const countryList2 = document.getElementById("country-list2");
async function fetchCountries2(input1) {
    try {
        let response = await (0, _axiosDefault.default).get(API_KEY);
        ...
        for(let i = 0; i < mappedResponse.length; i++)countryList2.innerHTML += `
